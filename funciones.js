 ...
 **************************************************************/
 ...
 function haGanado() {
     ...
     if (palabra == palabraBuscada){
         ...
         mensajeGanador = mensajeGanador + '<h3 text-center>Ingrese aqui el nombre del jugador <input class="jugador" name="jugador" type="text" minlength="3" maxlength="3" size="3">'
         ...
         for (j = 0; j < 5; j++) {
             if (palabra[i] == palabraBuscada[j]) {
                 if (i == j) {
                     ...
                     //Suma 5 puntos por letra acertada
                     punt =  punt + 5;
                     $('#puntos').text(punt);
                     ...
                     //Suma 1 punto por letra acertada pero no posicion
                     punt = punt + 1;
                     $('#puntos').text(punt);
                     break;
                 }
